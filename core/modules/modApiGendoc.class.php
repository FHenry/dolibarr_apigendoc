...
/**
 * 	\defgroup	apigendoc	ApiGendoc module
 * 	\brief		ApiGendoc module descriptor.
 * 	\file		core/modules/modApiGendoc.class.php
 * 	\ingroup	apigendoc
 * 	\brief		Description and activation file for module ApiGendoc
 */
include_once DOL_DOCUMENT_ROOT . "/core/modules/DolibarrModules.class.php";

/**
 * Description and activation class for module ApiGendoc
 */
class modApiGendoc extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->picto = 'apigendoc@apigendoc'; // mypicto@apigendoc
        // Defined all module parts (triggers, login, substitutions, menus, css, etc...)
        // for default path (eg: /apigendoc/core/xxxxx) (0=disable, 1=enable)
        // for specific path of parts (eg: /apigendoc/core/modules/barcode)
        // for specific css file (eg: /apigendoc/css/apigendoc.css.php)
        $this->module_parts = array(
            ...
            //'css' => 'apigendoc/css/mycss.css.php',
        ...
        // Example: this->dirs = array("/apigendoc/temp");
        $this->dirs = array();

        // Config pages. Put here list of php pages
        // stored into apigendoc/admin directory, used to setup module.
        $this->config_page_url = array("admin_apigendoc.php@apigendoc");
        ...
        $this->tabs = array(
            ...
            //	'objecttype:+tabname1:Title1:langfile@apigendoc:$user->rights->apigendoc->read:/apigendoc/mynewtab1.php?id=__ID__',
            //	// To add another new tab identified by code tabname2
            //	'objecttype:+tabname2:Title2:langfile@apigendoc:$user->rights->othermodule->read:/apigendoc/mynewtab2.php?id=__ID__',
        ...
        // Dictionnaries
        if (! isset($conf->apigendoc->enabled)) {
        	$conf->apigendoc = ( object ) array ();
            $conf->apigendoc->enabled = 0;
        }
        $this->dictionnaries = array();
        /* Example:
          // This is to avoid warnings
          if (! isset($conf->apigendoc->enabled)) $conf->apigendoc->enabled=0;
          $this->dictionnaries=array(
          'langs'=>'apigendoc@apigendoc',
        ...
        //	'type'=>'top',
        //	'titre'=>'ApiGendoc top menu',
        //	'mainmenu'=>'apigendoc',
        //	'leftmenu'=>'apigendoc',
        //	'url'=>'/apigendoc/pagetop.php',
        //	// Lang file to use (without .lang) by module.
        //	// File must be in langs/code_CODE/ directory.
        //	'langs'=>'mylangfile',
        //	'position'=>100,
        //	// Define condition to show or hide menu entry.
        //	// Use '$conf->apigendoc->enabled' if entry must be visible if module is enabled.
        //	'enabled'=>'$conf->apigendoc->enabled',
        //	// Use 'perms'=>'$user->rights->apigendoc->level1->level2'
        ...
        //	'type'=>'left',
        //	'titre'=>'ApiGendoc left menu',
        //	'mainmenu'=>'apigendoc',
        //	'leftmenu'=>'apigendoc',
        //	'url'=>'/apigendoc/pagelevel1.php',
        //	// Lang file to use (without .lang) by module.
        //	// File must be in langs/code_CODE/ directory.
        //	'langs'=>'mylangfile',
        //	'position'=>100,
     ...
     * and create data commands must be stored in directory /apigendoc/sql/
    ...
    {
        return $this->_load_tables('/apigendoc/sql/');
    }
}
