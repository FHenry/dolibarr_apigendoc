...
/**
 *	\file		lib/apigendoc.lib.php
 *	\ingroup	apigendoc
 *	\brief		This file is an example module library
 *				Put some comments here
 */

function apigendocAdminPrepareHead()
{
    global $langs, $conf;
    ...
    $head[$h][0] = dol_buildpath("/apigendoc/admin/admin_apigendoc.php", 1);
    $head[$h][1] = $langs->trans("Settings");
    $head[$h][2] = 'settings';
    $h++;
    $head[$h][0] = dol_buildpath("/apigendoc/admin/about.php", 1);
